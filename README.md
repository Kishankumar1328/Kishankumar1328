...
## Cloud
[![GitHub](https://img.shields.io/badge/-GitHub-<COLOR>?style=flat-square&logo=GitHub&link=https://github.com/kishankumar1328)](https://github.com/kishankumar1328)

<script>
const colors = ['red', 'green', 'blue', 'yellow', 'purple', 'orange'];

function changeColor() {
  const badge = document.querySelector('img[alt="GitHub"]');
  const randomIndex = Math.floor(Math.random() * colors.length);
  const randomColor = colors[randomIndex];
  badge.src = `https://img.shields.io/badge/-GitHub-${randomColor}?style=flat-square&logo=GitHub&link=https://github.com/kishankumar1328`;
}
